        ...
        <section className="w-full py-6 md:py-15 justify-center items-center">
            <div className="max-w-[1332px] mx-auto px-5.5 md:px-4">
                <div className="flex flex-col gap-2 md:gap-7 items-center text-center">
                    <Heading1 classDynamic="max-w-[258px] md:max-w-[600px]" title={hero.heading}/>
                    <Content1 classDynamic="max-w-[290px] md:max-w-[830px] mb-1.5 md:mb-0" content={hero.content}/>
                    <Button1 href={hero.buttonLink} text={hero.buttonLabel}/>
                ...
                <div className="flex flex-col pt-8 md:pt-15 text-center">
                    <Heading2 classDynamic="max-w-[268px] mx-auto md:max-w-[100%] mb-3" title={steps.heading}/>
                    <Content1 content={steps.content} />
